...
A weak data model rarely sends an invoice with a clear label. The costs hide, and they add up:
...
- **Performance:** clean structures can be queried efficiently. Tangled models force complicated, slow
  queries, and the site becomes sluggish without the "actual" feature being to blame.
