...
- **Direkter Umsatzverlust:** Jede Minute, in der ein Shop oder eine Anwendung nicht erreichbar ist,
  kostet konkret Geld.
- **Vertrauen:** Nutzer, die auf eine Fehlerseite stoßen, kommen seltener wieder — der Schaden
...
Mehr dazu unter [Infrastructure](/de/services/infrastructure/). Verwandte Beiträge:
[Warum wir auf bewährte Technologie setzen](/de/blog/boring-technology/) und
[Die versteckten Kosten eines schlechten Datenmodells](/de/blog/bad-data-model/).
