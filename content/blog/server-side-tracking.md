...
- clear **documentation** of the measurement concept, so the setup doesn't depend on one person's
  knowledge,
- and a conscious approach to change: every new feature on the website can affect tracking — those who
...
Learn more on our [Measurement Infrastructure](/en/services/measurement-infrastructure/) page. Related:
[Why a Hugo website loads faster and ranks better](/en/blog/hugo-website-performance/) and
[The hidden cost of a bad data model](/en/blog/bad-data-model/).
